...
import 'package:shareRIDE/app/pages/event/event_presenter.dart';
...
class EventController extends Controller {
  ...
  void _getIsRegistered() {
    loadOnStart();
    _eventPresenter.isRegistered(uid: _user.user_name, eventId: _event.id);
  }

  void handleRegistration() {
    showLoading();
    if (_isRegistered) {
      _eventPresenter.unRegisterFromEvent(uid: _user.user_name, eventId: _event.id);
    } else {
      _eventPresenter.registerForEvent(uid: _user.user_name, eventId: _event.id);
    }
  }
