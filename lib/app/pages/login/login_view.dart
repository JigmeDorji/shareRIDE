...
import 'package:shareRIDE/app/pages/login/login_controller.dart';
import 'package:shareRIDE/data/repositories/data_authentication_repository.dart';
import 'package:modal_progress_hud/modal_progress_hud.dart';
import 'package:shareRIDE/app/components/inputField.dart';
import 'package:shareRIDE/app/utils/constants.dart';
import 'package:shareRIDE/app/components/ensure_focus.dart';
                  ...
                  Container(
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          padding:
                               EdgeInsets.only(top: MediaQuery.of(context).size.height / 10, bottom: 1.0),
                          child: Image(
